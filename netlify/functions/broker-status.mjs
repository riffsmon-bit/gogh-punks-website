  ...
  return json(
    {
      ...
      externalFreeMintTest: {
        ...
        controls: {
          ...
          accountDailyAcquisitionLimitForTest: "2",
        ...
        readiness: {
          ...
          ownerMandateArmed: false,
          agentAuthorized: false,
          autonomousMintFeatureEnabled: false,
          exactExecutionPrepared: false,
        },
        notice: "Preparation only. The collection is unverified. No site or agent execution is enabled.",
      },
      featureFlags,
      scoutStatus: {
