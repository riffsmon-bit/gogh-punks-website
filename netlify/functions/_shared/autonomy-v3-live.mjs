...
function normalizeGlobal(values, nowSeconds) {
  ...
  const expected = {
    adapter: automationManifest.contracts.AutomatedSeaDropStudioFreeMintAdapter.runtimeBytecodeHash,
    policyModule: automationManifest.contracts.BrokerPolicyModuleV3.runtimeBytecodeHash,
    accountRegistry: automationManifest.contracts.GoghPunkAccountRegistryV3.runtimeBytecodeHash,
  };
...
export async function readAutomationV3PunkState(tokenIdValue, environment = process.env, options = {}) {
