...
export const BROKER_PROMPTS = Object.freeze([
  ...
  example("burn", "Permanent training", "Burn a Punk for training credit",
    "Open the Forge", "The selected owner test burns #1753 to credit #93. Burning permanently destroys the source NFT and can remove access to its wallets. Recheck the selected test to review setup, approval and burn.", "SELECTED OWNER TEST", "forge"),
  example("learn", "Permanent training", "Spend a credit to learn a skill",
    "Open my skills", "The selected owner can learn Rarity Eye on #93 after enabling Forge and earning a training credit. Review each training transaction.", "SELECTED OWNER TEST", "forge"),
  example("loadout", "Permanent training", "Equip, unequip or unlock a slot",
    "Open my loadout", "For the selected owner test, claim #93’s initial rarity slots if needed, then equip Rarity Eye after learning it. Recheck while chain finality is pending.", "SELECTED OWNER TEST", "forge"),
  example("paid", "Marketplace missions", "Mint a paid NFT",
    "Mint one NFT from Peppies World for up to 0.0001 ETH.",
    "Selected owner and Punk #93 test. Review the live mint price, fixed worker fee and expiry. One wallet budget confirmation lets the worker execute and verify delivery.", "SELECTED OWNER TEST"),
