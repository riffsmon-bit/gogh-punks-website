...
- The next live paid-mint test needs a fresh owner-reviewed budget confirmation. Floor sweeps and WETH bids remain outside the deployed capability set. The broader swarm changes remain on their integration branch.
