...
import { screenAutomatedSeaDropV3Candidate } from "./automated-seadrop-v3-screen.mjs";

export const AUTOMATED_LIVE_SCREEN_SCHEMA = "GOGH_AUTOMATED_SEADROP_V3_LIVE_SCREEN_V1";
