...
export const AUTOMATED_EXECUTION_BATCH_SCHEMA = "GOGH_AUTOMATED_SEADROP_V3_EXECUTION_BATCH_V1";
...
export function buildAutomatedSeaDropV3ExecutionBatch(
  profileInput,
  liveStateInput,
  options = {},
) {
  const plan = buildAutomatedSeaDropV3RunPlan(profileInput, liveStateInput, options);
