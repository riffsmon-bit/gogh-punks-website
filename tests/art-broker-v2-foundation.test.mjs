...
test("V2 migration is additive, lane-free, and never stores signing material", async () => {
  const sql = await readFile(new URL(
    "../netlify/database/migrations/20260906010000_create_art_broker_v2.sql",
    import.meta.url,
  ), "utf8");
  for (const table of ["broker_v2_profiles", "broker_v2_strategies",
    ...
    "broker_v2_model_registry", "broker_v2_provider_usage"]) assert.match(sql, new RegExp(table));
