...
try{
  ...
  for(const [width,height]of [[1440,1000],[375,900],[320,900]]){
    ...
    if(args[3]==='--local-url') {
      ...
      await evaluate(`document.querySelector('[data-confirmation-dialog]').close()`);
      assert.match(await evaluate(`document.querySelector('[data-swarm-panel]').textContent`),/Other Punks are still waiting/);result.swarmReviewPassed=true;result.passiveSwarmReviewPassed=true;
  ...
  for(const path of ['/swarm-wallet-rpc.js','/swarm-wallet-errors.js','/punk-agent-creation.js','/punk-agent-creation-panel.js','/swarm-wallet-release.js','/swarm-wallet-client.js','/swarm-wallet-panel.js','/broker/v2/index.html','/broker-v2.js','/broker-mission-status.js','/forge-skill-admin-panel.js','/broker-persistent-watch-mount.js','/broker-persistent-watch.js','/broker-v2.css','/broker-persistent-watch.css','/broker-agent-options.js','/directed-paid-public-panel.js','/erc20-withdraw-panel.js','/forge-holder-inspection-panel.js','/guide/index.html','/broker-action-feedback.js','/broker-mission-status.js','/forge-paid-release.js','/forge-paid-panel.js','/forge-paid-wallet.js','/broker-swarm.js','/broker-swarm-review.js','/broker-swarm-funding.js','/broker-activation-status.js','/broker-mission-notifications.js','/broker-feature-help.js','/forge-selected-burn-panel.js','/forge-holder-inspection-panel.js']){
